...
const ifos: Ifo[] = [
  ...
  {
    id: 'k1',
    address: '0x2415E4723F78e97e78E601c1a89a74378B0AbA8C',
    isActive: true,
    name: 'dKnight',
    subTitle:
      'dKnight is the prominent decentralized exchange (DEX) on Fantom Opera that focuses on providing the highest quality Decentralized Finance (DeFi) experience.',
    description:
      'At dKNIGHT we help investors stack their riches & unlock the ability to earn multiple passive income streams. To do so, investors are incentivized to provide liquidity on the dKNIGHT platform through yield farming to earn the native currency, $dKNIGHT. Investors can then use their earned $dKNIGHT tokens to stake in Markets to earn partner tokens. $dKNIGHT will also be used for many other features that can be found within the platform. The possibilities are endless but one thing’s for sure there will always be a shot for the moon at dKNIGHT.',
    launchDate: '26 November',
    launchTime: '3:00 PM UTC',
    saleAmount: '12,00,000 dKNIGHT',
    raiseAmount: '$300000',
    cakeToBurn: '$45000', // it is wizard buyback
    projectSiteUrl: 'https://dark.knightswap.financial',
    currency: 'USDC',
